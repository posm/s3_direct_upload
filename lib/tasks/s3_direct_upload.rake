namespace :s3_direct_upload do
  ...
  task :clean_remote_uploads => :environment do
    ...
    s3     = Fog::Storage.new(provider: "AWS", aws_access_key_id: S3DirectUpload.config.get_access_key_id, aws_secret_access_key: S3DirectUpload.config.get_secret_access_key)
